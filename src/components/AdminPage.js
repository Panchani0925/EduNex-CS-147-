...
import {
  Typography, Card, CardContent, Grid, Paper, Button, Switch, TextField, Dialog, DialogTitle, DialogContent, DialogActions,
  Table, TableBody, TableCell, TableContainer, TableHead, TableRow, MenuItem, FormControl, InputLabel, Select, Chip, Rating,
} from "@mui/material";
    ...
    <div className={`admin-page ${darkMode ? "dark-mode" : "light-mode"}`}>
      ...
      <Dialog open={openGenerateReportDialog} onClose={handleCloseGenerateReportDialog} maxWidth="md" fullWidth>
        ...
        <DialogActions>
          {!showReportPreview ? (
            <>
              <Button onClick={handleCloseGenerateReportDialog} >
                Cancel
              </Button>
