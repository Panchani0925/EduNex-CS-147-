...
// Removed Header import to use inline header like register page
  ...
  return (
    <>
      ...
      <header className="shadow p-4">
        <h1 className="text-center text-2xl font-bold text-current">
          Welcome to EduNex
        </h1>
      </header>
      <div
      ...
      >
        ...
        <div className="relative">
          ...
          >
            {/* NEW INLINE HEADER (like Register page header) */}
